...
import com.mpx.minipx.service.admin.LoginLogService;
...
public class LoginLogController {
    ...
    public ResponseEntity<?> getLoginLogList(@RequestBody Map<String, Object> inData,
        ...
        result = loginLogService.getLoginLogList(inData);
        return ResponseEntity.ok(result);
    }
}
